...
* Always use four (4) space indents, never use tabs
* Limit line lengths to 80 lines (we're looking at you comments)
* Use multi-line CSS (i.e., one selector/attribute per line), *no* inline CSS
* Use white space respnosibily, to make your CSS more readable

## CSS Guidlines adapted from CSS Wizardry (http://cssguidelin.es/#the-importance-of-a-styleguide)
